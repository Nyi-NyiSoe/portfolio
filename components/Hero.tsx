...
const Hero: React.FC = () => {
  ...
  return (
    <div id="home" className="min-h-screen flex items-center justify-center relative bg-[url('https://picsum.photos/1920/1080?blur=10&grayscale')] bg-cover bg-center bg-no-repeat">
